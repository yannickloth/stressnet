...
load res_smtp_pcre_999_udp_zero.txt
values=res_smtp_pcre_999_udp_zero;
quantity=200000;
ratio=999;
repeat=50;
...
plot(b,moyenne,'g');
saveas(VALSFIG,'values_smtp_pcre_999_udp_zero','png');
...
plot(b,moydev(:,3),'mx');
plot(b,moydev(:,4),'mx');
saveas(STATVALSFIG,'stats_smtp_pcre_999_udp_zero','png');
